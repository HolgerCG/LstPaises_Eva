...
public class AdaptadorLugaresTuristicos extends ArrayAdapter<LugarTuristico> {
    public AdaptadorLugaresTuristicos(Context context, ArrayList<LugarTuristico> datos){
